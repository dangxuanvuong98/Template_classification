...
def efficientnet_params(model_name,num_classes):
...
def get_model_params(model_name, override_params,image_size,num_classes):
    ...
    if model_name.startswith('efficientnet'):
        w, d, s, p = efficientnet_params(model_name,num_classes=num_classes)
        # note: all models have drop connect rate = 0.2
        blocks_args, global_params = efficientnet(
            width_coefficient=w, depth_coefficient=d, dropout_rate=p, image_size=image_size,num_classes=num_classes)
    else:
